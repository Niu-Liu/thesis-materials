...
w2_icrf1 = np.genfromtxt(
    "../logs/icrf1_gaiadr2_vsh02.log", usecols=(1,), skip_header=1)
w2_icrf2 = np.genfromtxt(
    "../logs/icrf2_gaiadr2_vsh02.log", usecols=(1,), skip_header=1)
w2_icrf3sx = np.genfromtxt(
    "../logs/icrf3sx_gaiadr2_vsh02.log", usecols=(1,), skip_header=1)
w2_icrf3k = np.genfromtxt(
    "../logs/icrf3k_gaiadr2_vsh02.log", usecols=(1,), skip_header=1)
w2_icrf3xka = np.genfromtxt(
    "../logs/icrf3xka_gaiadr2_vsh02.log", usecols=(1,), skip_header=1)
...
ax2.hist(apri_x_icrf3sx, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax2.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax2.text(6.5, 12, "ICRF3 S/X", fontsize=15)

ax2.set_ylim([0, 13])
ax2.set_ylabel("% in bin", fontsize=12)
ax2.grid()
ax2.set_yticks(np.arange(0, 16, 5))
ax2.yaxis.set_minor_locator(minorLocator)

# ICRF3 K
weights = np.ones_like(apri_x_icrf3k) * 100. / apri_x_icrf3k.size
ax3.hist(apri_x_icrf3k, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax3.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax3.text(6.5, 12, "ICRF3 K", fontsize=15)
...
ax4.hist(apri_x_icrf3xka, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax4.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax4.text(6.5, 12, "ICRF3 X/Ka", fontsize=15)
...
plt.tight_layout()
plt.savefig("../plots/apri-nor-sep-dist.eps")
plt.close()
...
# ICRF1
weights = np.ones_like(post_x_icrf1) * 100. / post_x_icrf1.size
ax0.hist(post_x_icrf1, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax0.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax0.text(6.5, 12, "ICRF1", fontsize=15)
...
# ICRF2
weights = np.ones_like(post_x_icrf2) * 100. / post_x_icrf2.size
ax1.hist(post_x_icrf2, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax1.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax1.text(6.5, 12, "ICRF2", fontsize=15)
...
# ICRF3 SX
weights = np.ones_like(post_x_icrf3sx) * 100. / post_x_icrf3sx.size
ax2.hist(post_x_icrf3sx, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax2.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax2.text(6.5, 12, "ICRF3 S/X", fontsize=15)
...
# ICRF3 K
weights = np.ones_like(post_x_icrf3k) * 100. / post_x_icrf3k.size
ax3.hist(post_x_icrf3k, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax3.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax3.text(6.5, 12, "ICRF3 K", fontsize=15)
...
# ICRF3 X/Ka
weights = np.ones_like(post_x_icrf3xka) * 100. / post_x_icrf3xka.size
ax4.hist(post_x_icrf3xka, bins_array, weights=weights, facecolor="g", alpha=0.75)
ax4.plot(bins_array, rayleigh_dist, "r--", linewidth=1)
ax4.text(6.5, 12, "ICRF3 X/Ka", fontsize=15)
...
plt.tight_layout()
plt.savefig("../plots/post-nor-sep-dist.eps", hbox="tight")
plt.close()
# --------------------------------- END --------------------------------
