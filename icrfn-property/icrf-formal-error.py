...
# ICRF2
ax2.plot(icrf2_vcs["nb_del"], icrf2_vcs["pos_err"], "b*", label="VCS-only", ms=1)
...
plt.tight_layout()
plt.savefig("../plots/error-vs-nobs.eps")
plt.close()
...
ax1.plot(icrf1_nor["nb_del"], icrf1_nor["pos_err"], "g^", label="North", ms=1)
...
ax2.plot(icrf2_nor["nb_del"], icrf2_nor["pos_err"], "g^", label="North", ms=1)
...
plt.tight_layout()
plt.savefig("../plots/error-vs-nobs-sou-nor.eps")
# --------------------------------- END --------------------------------
