...
# Right ascension
ax0.plot(gdr2_binned["dec"], gdr2_binned["ra_err"],
         "k-^", ms=2, label="Gaia DR2", lw=0.5)
ax0.plot(icrf1_binned["dec"], icrf1_binned["ra_err"],
         "g-v", ms=2, label="ICRF1", lw=0.5)
ax0.plot(icrf2_binned["dec"], icrf2_binned["ra_err"],
         "m-s", ms=2, label="ICRF2", lw=0.5)
ax0.plot(icrf3sx_binned["dec"], icrf3sx_binned["ra_err"],
         "r-x", ms=2, label="ICRF3 S/X", lw=0.5)
ax0.plot(icrf3k_binned["dec"], icrf3k_binned["ra_err"],
         "y-o", ms=2, label="ICRF3 K", lw=0.5)
ax0.plot(icrf3xka_binned["dec"], icrf3xka_binned["ra_err"],
...
# Declination
ax1.plot(gdr2_binned["dec"], gdr2_binned["dec_err"],
         "k-^", ms=2, label="Gaia DR2", lw=0.5)
ax1.plot(icrf1_binned["dec"], icrf1_binned["dec_err"],
         "g-v", ms=2, label="ICRF1", lw=0.5)
ax1.plot(icrf2_binned["dec"], icrf2_binned["dec_err"],
         "m-s", ms=2, label="ICRF2", lw=0.5)
ax1.plot(icrf3sx_binned["dec"], icrf3sx_binned["dec_err"],
         "r-x", ms=2, label="ICRF3 S/X", lw=0.5)
ax1.plot(icrf3k_binned["dec"], icrf3k_binned["dec_err"],
         "y-o", ms=2, label="ICRF3 K", lw=0.5)
ax1.plot(icrf3xka_binned["dec"], icrf3xka_binned["dec_err"],
         "b-*", ms=2, label="ICRF3 X/Ka", lw=0.5)
...
plt.savefig("../plots/pos-err-vs-dec_bgt.eps", hbox="tight")
# plt.savefig("../plots/fig03.eps")
# --------------------------------- END --------------------------------
