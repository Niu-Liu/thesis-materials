...
fig, (ax2, ax3, ax4) = plt.subplots(figsize=(10, 6), nrows=3,
                                              sharex=True, sharey=True)
...
ax2.text(4, 8, "ICRF3 S/X", fontsize=15)
ax2.legend()
...
ax3.text(4, 8, "ICRF3 K", fontsize=15)
ax3.legend()
...
ax4.text(4, 8, "ICRF3 X/Ka", fontsize=15)
ax4.legend()
...
plt.savefig("../plots/nor-sep-dist_bgt-1.eps", hbox="tight")
plt.close()
# --------------------------------- END --------------------------------
