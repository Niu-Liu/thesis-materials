...
ax0.vlines(3.52, 10, 600000, colors="k", linestyles="dashed", lw=0.1)
...
ax1.vlines(3.94, 10, 600000, colors="k", linestyles="dashed", lw=0.1)
...
ax2.vlines(3.99, 10, 600000, colors="k", linestyles="dashed", lw=0.1)
...
ax3.vlines(3.58, 10, 600000, colors="k", linestyles="dashed", lw=0.1)
...
ax4.vlines(3.53, 10, 600000, colors="k", linestyles="dashed", lw=0.1)
...
plt.subplots_adjust()
plt.tight_layout()
plt.savefig("../plots/gaia-vlbi-separation.eps")
# --------------------------------- END --------------------------------
