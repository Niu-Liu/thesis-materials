...
print('''
################################################################################
### Spin between TGAS and Hip2 (All) begins.''', file=flog)
...
print('''
################################################################################
### Spin between TGAS and Hip2 (M-K giants only) begins.''', file=flog)
...
print('''
################################################################################
### Spin between TGAS and Hip2 (O-B5 stars only) begins.''', file=flog)
